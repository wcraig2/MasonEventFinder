<script lang="ts">
	...
	function hasHiddenContent(el: HTMLElement) {
	...
	function formatPlaceType(str: String) {
		const capitalized = str.charAt(0).toUpperCase() + str.slice(1);
		return capitalized.replace(/_/g, ' ');
	}

	/** Initializes an array of zeros with the given size. */
	function initArray(arraySize: number) {
		const array = [];
...
<head>
	...
	<script>
		const CONFIGURATION = {
			...
			pois: [
				{ placeId: 'ChIJSX_b4JNOtokRgSiq9qr-k9g' },
				{ placeId: 'ChIJJWeNF8JOtokRTqW4jcvU6-Y' },
				{ placeId: 'ChIJmw3Qq5ZFtokRCvZWvkYTG3I' },
				{ placeId: 'ChIJXYL9vh1PtokRHH5GG-cr1nU' },
				{ placeId: 'ChIJ24RhOjtMtokRQRI4KYgfG0E' },
				{ placeId: 'ChIJ_TaGrpNOtokRFLtk85H0G2o' },
				{ placeId: 'ChIJizJdmVxOtokRuaAKePUTZ5g' },
				{ placeId: 'ChIJx3W8dbtOtokRE1h7XHOvdtM' },
				{ placeId: 'ChIJYxDJwR9PtokRQU36B1J0sUY' },
				{ placeId: 'ChIJ40i1jeZOtokRD8MCCkn8Nvw' },
				{ placeId: 'ChIJAX16vFxOtokRiR6jPO4wvbk' },
				{ placeId: 'ChIJI4hKpB9PtokR96MjeSrHRA8' },
				{ placeId: 'ChIJJSr5QuhOtokRw60Msy3WKr4' },
				{ placeId: 'ChIJLxhxlMFOtokRQ84oFwQK_6E' },
				{ placeId: 'ChIJA3FvUuFOtokRnzJVcnBOd84' },
				{ placeId: 'ChIJJ0Jku1xOtokRVZPZPcMIigY' },
				{ placeId: 'ChIJO-94Qr1OtokRQLJi2m7RKn0' },
				{ placeId: 'ChIJtwx1DJNOtokRHigoLp-YKbg' },
				{ placeId: 'ChIJ121-_elOtokRhB05iU5eMTQ' },
				{ placeId: 'ChIJgxKwYeZOtokRf30Md6BQrXY' },
				{ placeId: 'ChIJiZltvpNOtokRL6yIG2PIv3g' },
				{ placeId: 'ChIJ7Y5SySRMtokRRWAh8R2jcP4' },
				{ placeId: 'ChIJUwo3mmZOtokRXZevnxxeOXM' },
				{ placeId: 'ChIJOx-5GptOtokRSo8kZVaAdpo' },
				{ placeId: 'ChIJYxxVCX5LtokR7rEiApLc2iA' },
				{ placeId: 'ChIJ1QmPYZFOtokRiYgIraVyXGY' },
				{ placeId: 'ChIJ6d6UDS9MtokRpDszgE9ARII' },
				{ placeId: 'ChIJr9srY5JOtokRVK3j5dyuAqw' },
				{ placeId: 'ChIJWz34ho1OtokRuo0Bu912Hkw' },
				{ placeId: 'ChIJfyUL-HJOtokRm1zRqxc8Ei4' },
				{ placeId: 'ChIJy_sYlu1OtokRHGxnplGDMuM' },
				{ placeId: 'ChIJD-JVxuxOtokRpRw7E3M9rVQ' }
			],
			centerMarker: { icon: 'circle' },
			mapRadius: 3500,
			mapOptions: {
				center: { lat: 38.8314578, lng: -77.31174709999999 },
			...
			mapsApiKey: 'AIzaSyDWfdtAApLBudYIU6uOLO69BNmc3S7kZjQ'
		};
...
<body>
		...
		<div class="photo-modal">
			...
			<div>
				...
				<div class="photo-text">
					...
					<div class="photo-attrs">Photo by <span /></div>
				</div>
			</div>
		</div>
	...
	<script
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAU68NcpPjxKvPLJQ0Fjy5pXR0gzBWmk4c&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_neighborhooddiscovery_v2_cABCDEF"
		async
		defer
	></script>
</body>
